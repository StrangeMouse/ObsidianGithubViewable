...
- Rückstellkraft ist eine Kombination aus Federkraft und Gewichtskraft$$\begin{aligned}F_r&=F_F - F_G \\ F_r &= D \cdot s -m\cdot g \\ F_{r}&= D\cdot s-D\cdot s_{0}\\ F_{r}&=D\cdot (s-s_{0}) \\ F_{r}&=(-)D\cdot y\end{aligned}$$
