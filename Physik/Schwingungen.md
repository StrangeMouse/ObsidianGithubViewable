...
- Rückstellkraft ist eine Kombination aus Federkraft und Gewichtskraft$$\begin{aligned}F_r&=F_F - F_G \\ F_r &= D \cdot s_{1} -m\cdot g \\ F_{r}&= D\cdot s_{1}-D\cdot s_{2}\\ F_{r}&=D\cdot (s_{1}-s_{2}) \end{aligned}$$
